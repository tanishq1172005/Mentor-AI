...
export default function Register(){
    ...
    const handleSubmit =async(e)=>{
        e.preventDefault()
        try{
            const res = await axios.post(`${BASE_URL}/${API_PATHS.AUTH.REGISTER}`,{name,email,password})
      ...
      <div className="w-1/2 flex items-center justify-center bg-[#121212]">
        <div className="bg-[#1a1a1a] p-10 rounded-2xl w-96 shadow-xl">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <p className="text-sm text-center">Already have an account? <Link to='/login' className="text-blue-500">Log In</Link></p>
          </form>
